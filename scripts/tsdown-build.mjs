...
function resolveTsdownMaxOldSpaceMb(params = {}) {
  ...
  const rawEnvOverride = (params.env ?? process.env)[TSDOWN_MAX_OLD_SPACE_MB_ENV];
  if (typeof rawEnvOverride === "string" && rawEnvOverride.trim() !== "") {
    return parsePositiveInt(rawEnvOverride, TSDOWN_MAX_OLD_SPACE_MB_ENV);
  }
