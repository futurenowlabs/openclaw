...
<Accordion title="Common import path table">
  ...
  | `plugin-sdk/gateway-runtime` | Gateway helpers | Least-privilege backend `callGateway`, Gateway client, event-loop-ready start helper, and channel-status patch helpers |
